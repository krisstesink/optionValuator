...
class OptionsTest < ApplicationSystemTestCase
  ...
  test "should create option" do
    ...
    fill_in "Expiry date", with: @option.expiry_date
    fill_in "Option type", with: @option.option_type
    fill_in "Risk free rate", with: @option.risk_free_rate
    fill_in "Stock price", with: @option.stock_price
    fill_in "Strike price", with: @option.strike_price
    fill_in "Volatility", with: @option.volatility
