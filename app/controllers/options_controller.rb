class OptionsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to options_path, status: :see_other, notice: "Option was successfully destroyed." }
  ...
  private
    ...
    def option_params
      params.require(:option).permit(:stock_price, :strike_price, :expiry_date, :risk_free_rate, :volatility, :option_type)
    end
end
